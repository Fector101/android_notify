...
requirements = python3, kivy, pyjnius, android-notify==1.60.4+nodep
...
[tool.flet.android]
dependencies = [
  "pyjnius","android-notify==1.60.4+nodep"
]
...
- In pip section where you're asked to insert `Libary name` paste `android-notify==1.60.4+nodep`
